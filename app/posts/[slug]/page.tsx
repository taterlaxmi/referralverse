        ...
        <article id="content" className="container mx-auto px-4 py-12">
          ...
          {post.heroImage && (
            <div className="mb-6 flex justify-center">
              <Image
                src={post.heroImage}
                alt={post.heroImageAlt || `${post.brand} referral offer and promo code`}
                width={600}
                height={400}
          ...
          {post.proofImage && (
            <section className="my-20">
              {post.proofImageHeader && (
                <h2 className="text-3xl md:text-4xl font-semibold mb-10 flex items-center gap-3 text-gray-900">
                  <svg className="w-8 h-8 text-amber-500 drop-shadow-sm" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
              ...
              <div className="flex justify-center bg-gray-50 rounded-3xl p-4 md:p-8 border border-dashed border-gray-300">
                <Image
                  src={post.proofImage}
                  alt={post.proofImageAlt || `${post.brand} referral bonus proof screenshot`}
                  width={600}
                  height={400}
